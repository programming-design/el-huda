...
const asmaList = [
  {ar:"الرَّحْمَن", tr:"Ar-Rahman", en:"The Most Merciful", fr:"Le Tout Miséricordieux", ar_meaning:"الذي وسعت رحمته كل شيء"},
  {ar:"الرَّحِيم", tr:"Ar-Rahim", en:"The Most Compassionate", fr:"Le Très Miséricordieux", ar_meaning:"الذي يرحم المؤمنين رحمة خاصة"},
  {ar:"الْمَلِك", tr:"Al-Malik", en:"The King", fr:"Le Roi", ar_meaning:"المالك لكل شيء"},
  {ar:"الْقُدُّوس", tr:"Al-Quddus", en:"The Most Sacred", fr:"Le Très Saint", ar_meaning:"المنزّه عن كل عيب ونقص"},
  {ar:"السَّلَام", tr:"As-Salam", en:"The Source of Peace", fr:"La Paix", ar_meaning:"مصدر السلام والأمان"},
  {ar:"الْمُؤْمِن", tr:"Al-Mu'min", en:"The Giver of Faith", fr:"Celui qui donne la foi", ar_meaning:"يمنح الأمان والإيمان"},
  {ar:"الْمُهَيْمِن", tr:"Al-Muhaymin", en:"The Guardian", fr:"Le Protecteur", ar_meaning:"الرقيب الحافظ لكل شيء"},
  {ar:"الْعَزِيز", tr:"Al-Aziz", en:"The Almighty", fr:"Le Tout-Puissant", ar_meaning:"القوي الذي لا يُغلب"},
  {ar:"الْجَبَّار", tr:"Al-Jabbar", en:"The Compeller", fr:"Le Contraignant", ar_meaning:"يُصلح الكسر ويُجبر الضعف"},
  {ar:"الْمُتَكَبِّر", tr:"Al-Mutakabbir", en:"The Supreme", fr:"Le Majestueux", ar_meaning:"المتعالي بعظمته"},
  {ar:"الْخَالِق", tr:"Al-Khaliq", en:"The Creator", fr:"Le Créateur", ar_meaning:"المُوجِد للخلق من العدم"},
  {ar:"الْبَارِئ", tr:"Al-Bari", en:"The Originator", fr:"Celui qui donne un commencement", ar_meaning:"المُميِّز للخلق وفارئه"},
  {ar:"الْمُصَوِّر", tr:"Al-Musawwir", en:"The Fashioner", fr:"Le Formateur", ar_meaning:"المُصوِّر للخلق بصور بديعة"},
  {ar:"الْغَفَّار", tr:"Al-Ghaffar", en:"The Constant Forgiver", fr:"Le Grand Pardonneur", ar_meaning:"كثير المغفرة للذنوب"},
  {ar:"الْقَهَّار", tr:"Al-Qahhar", en:"The All-Compelling Subduer", fr:"Le Dominateur", ar_meaning:"الغالب القاهر فوق كل شيء"},
  {ar:"الْوَهَّاب", tr:"Al-Wahhab", en:"The Bestower", fr:"Celui qui accorde sans compter", ar_meaning:"كثير العطاء والهبة"},
  {ar:"الرَّزَّاق", tr:"Ar-Razzaq", en:"The Provider", fr:"Le Grand Pourvoyeur", ar_meaning:"المتكفل بأرزاق العباد"},
  {ar:"الْفَتَّاح", tr:"Al-Fattah", en:"The Opener", fr:"Celui qui ouvre", ar_meaning:"يفتح أبواب الخير والرزق"},
  {ar:"اَلْعَلِيْم", tr:"Al-'Alim", en:"The All-Knowing", fr:"L'Omniscient", ar_meaning:"المحيط علمه بكل شيء"},
  {ar:"الْقَابِض", tr:"Al-Qabid", en:"The Withholder", fr:"Celui qui retient", ar_meaning:"يقبض الأرزاق ويُمسكها"},
  {ar:"الْبَاسِط", tr:"Al-Basit", en:"The Extender", fr:"Celui qui étend", ar_meaning:"يبسط الرزق ويُوسّعه"},
  {ar:"الْخَافِض", tr:"Al-Khafid", en:"The Reducer", fr:"Celui qui abaisse", ar_meaning:"يخفض الجبابرة والطغاة"},
  {ar:"الرَّافِع", tr:"Ar-Rafi'", en:"The Exalter", fr:"Celui qui élève", ar_meaning:"يرفع المؤمنين بطاعته"},
  {ar:"الْمُعِزّ", tr:"Al-Mu'izz", en:"The Bestower of Honor", fr:"Celui qui honore", ar_meaning:"يعز من يشاء من عباده"},
  {ar:"المُذِلّ", tr:"Al-Mudhill", en:"The Humiliator", fr:"Celui qui humilie", ar_meaning:"يُذل من يشاء بحكمته"},
  {ar:"السَّمِيع", tr:"As-Sami'", en:"The All-Hearing", fr:"L'Audient", ar_meaning:"يسمع كل صوت وكلام"},
  {ar:"الْبَصِير", tr:"Al-Basir", en:"The All-Seeing", fr:"Le Clairvoyant", ar_meaning:"يرى كل شيء ظاهراً وخفياً"},
  {ar:"الْحَكَم", tr:"Al-Hakam", en:"The Judge", fr:"L'Arbitre", ar_meaning:"الفاصل بالحق بين الخلق"},
  {ar:"الْعَدْل", tr:"Al-'Adl", en:"The Utterly Just", fr:"Le Juste", ar_meaning:"البالغ العدل في حكمه"},
  {ar:"اللَّطِيف", tr:"Al-Latif", en:"The Subtly Kind", fr:"Le Tout Subtil", ar_meaning:"اللطيف بعباده في أموره"},
  {ar:"الْخَبِير", tr:"Al-Khabir", en:"The All-Aware", fr:"Le Bien-Informé", ar_meaning:"الخبير بظواهر الأمور وبواطنها"},
  {ar:"الْحَلِيم", tr:"Al-Halim", en:"The Forbearing", fr:"Le Très Doux", ar_meaning:"الصفوح ذو الأناة الذي لا يستعجل"},
  {ar:"الْعَظِيم", tr:"Al-'Azim", en:"The Magnificent", fr:"L'Immense", ar_meaning:"العظيم في ذاته وصفاته"},
  {ar:"الْغَفُور", tr:"Al-Ghafur", en:"The Great Forgiver", fr:"Le Pardonneur", ar_meaning:"واسع المغفرة لذنوب العباد"},
  {ar:"الشَّكُور", tr:"Ash-Shakur", en:"The Most Appreciative", fr:"Le Reconnaissant", ar_meaning:"يُثيب على الطاعة وإن قلت"},
  {ar:"الْعَلِيّ", tr:"Al-'Ali", en:"The Most High", fr:"Le Très Haut", ar_meaning:"الرفيع العلو فوق كل شيء"},
  {ar:"الْكَبِير", tr:"Al-Kabir", en:"The Most Great", fr:"Le Plus Grand", ar_meaning:"الكبير المتعالي في جلاله"},
  {ar:"الْحَفِيظ", tr:"Al-Hafiz", en:"The Preserver", fr:"Le Gardien", ar_meaning:"الحافظ لكل شيء من أن يفسد"},
  {ar:"المُقيت", tr:"Al-Muqit", en:"The Sustainer", fr:"Le Nourricier", ar_meaning:"المُقيت على أرزاق عباده"},
  {ar:"الْحسِيب", tr:"Al-Hasib", en:"The Reckoner", fr:"Celui qui suffit", ar_meaning:"الكافي لكل أحد"},
  {ar:"الْجَلِيل", tr:"Al-Jalil", en:"The Majestic", fr:"Le Majestueux", ar_meaning:"صاحب الجلال والكرم"},
  {ar:"الْكَرِيم", tr:"Al-Karim", en:"The Most Generous", fr:"Le Généreux", ar_meaning:"الجواد الكريم الكثير العطاء"},
  {ar:"الرَّقِيب", tr:"Ar-Raqib", en:"The Watchful", fr:"Le Vigilant", ar_meaning:"الرقيب على أعمال العباد"},
  {ar:"الْمُجِيب", tr:"Al-Mujib", en:"The Responsive", fr:"Celui qui répond", ar_meaning:"يُجيب دعوة الداعين"},
  {ar:"الْواسِع", tr:"Al-Wasi'", en:"The All-Encompassing", fr:"Le Vaste", ar_meaning:"الذي وسع كل شيء رحمةً وعلماً"},
  {ar:"الْحَكِيم", tr:"Al-Hakim", en:"The All-Wise", fr:"Le Sage", ar_meaning:"الحاكم بالحكمة والحجة"},
  {ar:"الْوَدُود", tr:"Al-Wadud", en:"The Most Loving", fr:"L'Affectueux", ar_meaning:"يُحب عباده ويودّهم"},
  {ar:"الْمَجِيد", tr:"Al-Majid", en:"The Most Glorious", fr:"Le Glorieux", ar_meaning:"البالغ الغاية في المجد والشرف"},
  {ar:"الْبَاعِث", tr:"Al-Ba'ith", en:"The Resurrector", fr:"Celui qui ressuscite", ar_meaning:"المُبعث للخلق بعد الموت"},
  {ar:"الشَّهِيد", tr:"Ash-Shahid", en:"The Witness", fr:"Le Témoin", ar_meaning:"الشاهد على كل شيء"},
  {ar:"الْحَقّ", tr:"Al-Haqq", en:"The Absolute Truth", fr:"La Vérité", ar_meaning:"الثابت على الحق الذي لا يزول"},
  {ar:"الْوَكِيل", tr:"Al-Wakil", en:"The Trustee", fr:"Le Garant", ar_meaning:"الكافل والضامن لمصالح العباد"},
  {ar:"الْقَوِيّ", tr:"Al-Qawiyy", en:"The All-Strong", fr:"Le Fort", ar_meaning:"الشديد القوة الكاملة"},
  {ar:"الْمَتِين", tr:"Al-Matin", en:"The Firm", fr:"Le Ferme", ar_meaning:"المتين الذي لا يُرام ولا يُضام"},
  {ar:"الْوَلِيّ", tr:"Al-Waliyy", en:"The Protecting Friend", fr:"Le Protecteur", ar_meaning:"الناصر لأوليائه"},
  {ar:"الْحَمِيد", tr:"Al-Hamid", en:"The Praiseworthy", fr:"Le Digne de louange", ar_meaning:"المستحق للحمد والثناء"},
  {ar:"الْمُحْصِي", tr:"Al-Muhsi", en:"The All-Accounting", fr:"Celui qui compte tout", ar_meaning:"المحصي لكل شيء بعلمه"},
  {ar:"الْمُبْدِئ", tr:"Al-Mubdi'", en:"The Originator", fr:"Celui qui commence", ar_meaning:"المبتدئ للخلق ابتداءً"},
  {ar:"الْمُعِيد", tr:"Al-Mu'id", en:"The Restorer", fr:"Celui qui restaure", ar_meaning:"المُعيد للخلق بعد فنائه"},
  {ar:"الْمُحْيِي", tr:"Al-Muhyi", en:"The Giver of Life", fr:"Celui qui donne la vie", ar_meaning:"المُحيي الذي يُحيي الأموات"},
  {ar:"اَلْمُمِيت", tr:"Al-Mumit", en:"The Bringer of Death", fr:"Celui qui fait mourir", ar_meaning:"المُميت الذي يُميت الأحياء"},
  {ar:"الْحَيّ", tr:"Al-Hayy", en:"The Ever-Living", fr:"Le Vivant", ar_meaning:"الحي الذي لا يموت"},
  {ar:"الْقَيُّوم", tr:"Al-Qayyum", en:"The Self-Subsisting", fr:"Celui qui subsiste par Lui-même", ar_meaning:"القائم بنفسه المقيم لغيره"},
  {ar:"الْواجِد", tr:"Al-Wajid", en:"The Perceiver", fr:"Celui qui trouve", ar_meaning:"الواجد الذي لا يعدم شيئاً"},
  {ar:"الْماجِد", tr:"Al-Majid", en:"The Illustrious", fr:"Le Noble", ar_meaning:"المجيد العظيم في ذاته"},
  {ar:"الْواحِد", tr:"Al-Wahid", en:"The One", fr:"L'Unique", ar_meaning:"المتفرد بالوحدانية"},
  {ar:"الْأَحَد", tr:"Al-Ahad", en:"The Unique", fr:"L'Unique", ar_meaning:"الأحد المتفرد بصفاته"},
  {ar:"الصَّمَد", tr:"As-Samad", en:"The Self-Sufficient", fr:"Celui dont tout dépend", ar_meaning:"الذي يُقصد في الحاجات"},
  {ar:"الْقَادِر", tr:"Al-Qadir", en:"The All-Capable", fr:"Le Capable", ar_meaning:"القادر على كل شيء"},
  {ar:"الْمُقْتَدِر", tr:"Al-Muqtadir", en:"The All-Determiner", fr:"Le Tout-Puissant", ar_meaning:"الشديد القدرة والتمكين"},
  {ar:"الْمُقَدِّم", tr:"Al-Muqaddim", en:"The Expediter", fr:"Celui qui avance", ar_meaning:"المُقدِّم لمن يشاء بحكمته"},
  {ar:"الْمُؤَخِّر", tr:"Al-Mu'akhkhir", en:"The Delayer", fr:"Celui qui retarde", ar_meaning:"المُؤخِّر لمن يشاء بعدله"},
  {ar:"الْأوَّل", tr:"Al-Awwal", en:"The First", fr:"Le Premier", ar_meaning:"الأول الذي لا بداية له"},
  {ar:"الْآخِر", tr:"Al-Akhir", en:"The Last", fr:"Le Dernier", ar_meaning:"الآخر الذي لا نهاية له"},
  {ar:"الظَّاهِر", tr:"Az-Zahir", en:"The Manifest", fr:"L'Apparent", ar_meaning:"الظاهر بآياته وأدلته"},
  {ar:"الْبَاطِن", tr:"Al-Batin", en:"The Hidden", fr:"Le Caché", ar_meaning:"الباطن العالم بكل خفية"},
  {ar:"الْوَالِي", tr:"Al-Wali", en:"The Governor", fr:"Le Gouverneur", ar_meaning:"المتولي أمور خلقه"},
  {ar:"الْمُتَعَالِي", tr:"Al-Muta'ali", en:"The Self-Exalted", fr:"Le Très Élevé", ar_meaning:"المتعالي عن صفات المخلوقين"},
  {ar:"الْبَرّ", tr:"Al-Barr", en:"The Source of Goodness", fr:"Le Bienfaiteur", ar_meaning:"البر الذي يُحسن إلى عباده"},
  {ar:"التَّوَّاب", tr:"At-Tawwab", en:"The Acceptor of Repentance", fr:"Celui qui accepte le repentir", ar_meaning:"الذي يقبل توبة التائبين"},
  {ar:"الْمُنْتَقِم", tr:"Al-Muntaqim", en:"The Avenger", fr:"Celui qui se venge", ar_meaning:"المنتقم ممن يشاء بعدله"},
  {ar:"العَفُوّ", tr:"Al-'Afuww", en:"The Pardoner", fr:"Celui qui pardonne", ar_meaning:"كثير العفو عن ذنوب العباد"},
  {ar:"الرَّؤُوف", tr:"Ar-Ra'uf", en:"The Most Kind", fr:"Le Compatissant", ar_meaning:"الرفيق بعباده في أحكامه"},
  {ar:"مَالِكُ الْمُلْك", tr:"Malik-ul-Mulk", en:"Owner of all Sovereignty", fr:"Maître de la Royauté", ar_meaning:"مالك الملك لا ينازعه أحد"},
  {ar:"ذُوالْجَلَالِ وَالْإِكْرَام", tr:"Dhul-Jalali wal-Ikram", en:"Lord of Majesty and Generosity", fr:"Maître de la Majesté et de la Générosité", ar_meaning:"ذو العظمة والكرم"},
  {ar:"الْمُقْسِط", tr:"Al-Muqsit", en:"The Equitable", fr:"L'Équitable", ar_meaning:"العادل في جميع أحكامه"},
  {ar:"الْجَامِع", tr:"Al-Jami'", en:"The Gatherer", fr:"Celui qui réunit", ar_meaning:"الجامع للخلق ليوم الحساب"},
  {ar:"الْغَنِيّ", tr:"Al-Ghani", en:"The Self-Sufficient", fr:"Le Riche par Lui-même", ar_meaning:"الغني عن كل ما سواه"},
  {ar:"الْمُغْنِي", tr:"Al-Mughni", en:"The Enricher", fr:"Celui qui enrichit", ar_meaning:"المُغني لعباده من فقر"},
  {ar:"الْمَانِع", tr:"Al-Mani'", en:"The Preventer of Harm", fr:"Celui qui empêche", ar_meaning:"الذي يمنع من يشاء بحكمته"},
  {ar:"الضَّار", tr:"Ad-Darr", en:"The Distresser", fr:"Celui qui afflige", ar_meaning:"المُقدِّر للضر بحكمته"},
  {ar:"النَّافِع", tr:"An-Nafi'", en:"The Benefiter", fr:"Celui qui profite", ar_meaning:"المُوجِد للنفع لعباده"},
  {ar:"النُّور", tr:"An-Nur", en:"The Light", fr:"La Lumière", ar_meaning:"نور السموات والأرض"},
  {ar:"الْهَادِي", tr:"Al-Hadi", en:"The Guide", fr:"Le Guide", ar_meaning:"الهادي من يشاء إلى الحق"},
  {ar:"الْبَدِيع", tr:"Al-Badi'", en:"The Incomparable Originator", fr:"Le Créateur incomparable", ar_meaning:"المُبدع للخلق بلا مثال"},
  {ar:"البَاقِي", tr:"Al-Baqi", en:"The Everlasting", fr:"L'Éternel", ar_meaning:"الباقي بعد فناء خلقه"},
  {ar:"الْوَارِث", tr:"Al-Warith", en:"The Inheritor", fr:"L'Héritier", ar_meaning:"الوارث الذي يبقى بعد فناء الكل"},
  {ar:"الرَّشِيد", tr:"Ar-Rashid", en:"The Guide to the Right Path", fr:"Le Bien-Guidant", ar_meaning:"الهادي إلى طريق الصواب"},
  {ar:"الصَّبُور", tr:"As-Sabur", en:"The Most Patient", fr:"Le Très Patient", ar_meaning:"الصبور الذي لا يستعجل بالعقوبة"}
];
